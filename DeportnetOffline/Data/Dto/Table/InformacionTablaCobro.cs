...
namespace DeportnetOffline.Data.Dto.Table
{
    public class InformacionTablaCobro
    {
        ...
        public InformacionTablaCobro(int id, int idSocio, char isSaleItem,string fullNameSocio, string itemName, string amount, DateTime? date, string synchronized, DateTime? syncronizedDate)
        {
            Id = id;
            IdSocio = idSocio;
