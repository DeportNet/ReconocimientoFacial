...
namespace DeportNetReconocimiento.SDK
{
    public class Hik_SDK
    {
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public void Init()
            {
                byDoorRight = new byte[Hik_SDK.MAX_DOOR_NUM_256];
                byBelongGroup = new byte[Hik_SDK.MAX_GROUP_NUM_128];
                wCardRightPlan = new ushort[Hik_SDK.MAX_DOOR_NUM_256 * Hik_SDK.MAX_CARD_RIGHT_PLAN_NUM];
                byCardNo = new byte[Hik_SDK .ACS_CARD_NO_LEN];
                byCardPassword = new byte[Hik_SDK.CARD_PASSWORD_LEN];
                byName = new byte[Hik_SDK.NAME_LEN];
                byRes2 = new byte[3];
                byLockCode = new byte[Hik_SDK.MAX_LOCK_CODE_LEN];
                byRoomCode = new byte[Hik_SDK.MAX_DOOR_CODE_LEN];
                byRes3 = new byte[83];
            }
        }
        ...
        public struct NET_DVR_FACE_PARAM_BYCARD
        {
            ...
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Hik_SDK.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Hik_SDK.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
         ...
         */
        [DllImportAttribute(rutaLibreriaSDK)]
