...
namespace DeportNetReconocimiento.GUI
{
    ...
    public partial class WFPanelOffline : Form
    {
        ...
        {
            InitializeComponent();
            controladora_Eventos = new Hik_Controladora_Eventos();
            controladora_General = new Hik_Controladora_General();
            controladora_Eventos.Initialize();
        ...
        private void ConnectToRealTimeEvents()
        {
            ...
            controladora_Eventos.Login("admin", "Facundo2024*", "8000", "192.168.0.207");
        ...
        {
            if (!controladora_Eventos.ObtenerStatusPanel())
            {
